...
GO
PRINT N'Creating [dbo].[FK_Employee_PurchaseInvoices]...';


GO
ALTER TABLE [dbo].[PurchaseInvoices]
    ADD CONSTRAINT [FK_Employee_PurchaseInvoices] FOREIGN KEY ([empId]) REFERENCES [dbo].[Employees] ([Id]);


GO
PRINT N'Creating [dbo].[FK_InvoiceTypes_PurchaseInvoices]...';


GO
ALTER TABLE [dbo].[PurchaseInvoices]
    ADD CONSTRAINT [FK_InvoiceTypes_PurchaseInvoices] FOREIGN KEY ([invTypeId]) REFERENCES [dbo].[InvoiceTypes] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Suppliers_PurchaseInvoices]...';


GO
ALTER TABLE [dbo].[PurchaseInvoices]
    ADD CONSTRAINT [FK_Suppliers_PurchaseInvoices] FOREIGN KEY ([suppId]) REFERENCES [dbo].[Suppliers] ([Id]);
...
SELECT [dbo].PurchaseInvoices.Id,
       ...
       [dbo].PurchaseInvoices.invSuppName as InvSuppName,
...
End
GO
PRINT N'Creating [dbo].[GetRePurchItems]...';


GO
CREATE PROCEDURE [dbo].[GetRePurchItems]
	@purchId int
AS
Begin
SELECT  [dbo].[PurchasesItems].Id,
        ...
        [dbo].ProductsDetails.expireDate
FROM [dbo].[PurchasesItems] 
INNER JOIN [dbo].ProductsDetails ON [dbo].[PurchasesItems].proddId = [dbo].ProductsDetails.Id
...
END
GO
PRINT N'Creating [dbo].[AddProdDetails]...';


GO
CREATE PROCEDURE [dbo].[AddProdDetails]
	@proId int,
	@purId int,
	@cost real,
	@price real,
...
EXEC IncDecProdQuantity @proId=@proId,@value=@quantity;
End
GO
...
EXEC AddProdDetails @proId=@prodId,@purId=@purchId,@cost=@Cost,@Price=@price,@quantity=@Quantity,@exDate=@expDate;
End
GO
