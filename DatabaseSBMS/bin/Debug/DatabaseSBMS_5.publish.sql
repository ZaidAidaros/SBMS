...
GO
PRINT N'Creating [dbo].[ReturnPurchaseItems]...';


GO
CREATE TABLE [dbo].[ReturnPurchaseItems] (
    [Id]       INT  IDENTITY (1, 1) NOT NULL,
    [purchId]  INT  NOT NULL,
...
GO
PRINT N'Creating [dbo].[FK_ReturnPurchaseItems_PurchaseInv]...';


GO
ALTER TABLE [dbo].[ReturnPurchaseItems]
    ADD CONSTRAINT [FK_ReturnPurchaseItems_PurchaseInv] FOREIGN KEY ([purchId]) REFERENCES [dbo].[PurchaseInvoices] ([Id]);


GO
PRINT N'Creating [dbo].[FK_ReturnPurchaseItems_ProductsDetails]...';


GO
ALTER TABLE [dbo].[ReturnPurchaseItems]
    ADD CONSTRAINT [FK_ReturnPurchaseItems_ProductsDetails] FOREIGN KEY ([proddId]) REFERENCES [dbo].[ProductsDetails] ([Id]);
...
SELECT [dbo].[ProductsDetails].Id,
	   ...
	   [dbo].[ProductsDetails].purchQuantity,
	   [dbo].[ProductsDetails].ProdExpireDate
FROM [dbo].[ProductsDetails] 
INNER JOIN [dbo].[Products] ON [dbo].[Products].Id = [dbo].[ProductsDetails].prodId
...
AS
Begin
SELECT  [dbo].ReturnPurchaseItems.Id,
        [dbo].Products.[name],
        [dbo].ReturnPurchaseItems.price,
        [dbo].ReturnPurchaseItems.quantity,
        [dbo].ProductsDetails.ProdExpireDate
FROM [dbo].ReturnPurchaseItems 
INNER JOIN [dbo].ProductsDetails ON [dbo].ReturnPurchaseItems.proddId = [dbo].ProductsDetails.Id
INNER JOIN [dbo].Products ON [dbo].ProductsDetails.prodId = [dbo].Products.Id
WHERE dbo.ReturnPurchaseItems.purchId = @purchId;
End
GO
...
AS
Begin
INSERT INTO [dbo].ReturnPurchaseItems(
            [dbo].ReturnPurchaseItems.purchId,
			[dbo].ReturnPurchaseItems.proddId,
			[dbo].ReturnPurchaseItems.price,
			[dbo].ReturnPurchaseItems.quantity
			) 
			VALUES (
