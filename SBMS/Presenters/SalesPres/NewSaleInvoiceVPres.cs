...
namespace SBMS.Presenters.SalesPres
{
    class NewSaleInvoiceVPres
    {
        ...
        private static NewSaleInvoiceVPres instance;
        public static NewSaleInvoiceVPres GetInstance()
        {
            if (instance == null) instance = new NewSaleInvoiceVPres();
            return instance;
        }
        ...
        private NewSaleInvoiceVPres()
        {
            this.newSaleInvoiceV = NewSaleInvoiceV.GetInstance();
            this.OnInitAsync();
        }
        ...
        {
            InvoiceItemM invoiceItemM = (InvoiceItemM)this.newSaleInvoiceV.DGVInvItems.SelectedRows[0].DataBoundItem;
            invoiceItemM.Price = decimal.Parse(this.newSaleInvoiceV.PPrice);
            invoiceItemM.Quantity = decimal.Parse(this.newSaleInvoiceV.InvItemQuantity);
            invoiceItemM.ExpireDate = this.newSaleInvoiceV.ExpireDate.Value.ToShortDateString();
